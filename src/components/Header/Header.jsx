...
function Header() {
  ...
  return (
    <div
    className='bg-white h-16 px-4 flex justify-between items-center border-b border-gray-200 shadow-sm relative z-10'>
      <div className='relative drop-shadow-sm'>
        <HiOutlineSearch fontSize={25} className='text-gray-400 absolute top-1/2 -translate-y-1/2 left-3 '/>
